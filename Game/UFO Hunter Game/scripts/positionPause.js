...
PausePosition.prototype.draw = function(play){
	...
	ctx.fillText("Tekan P: back to the current game", play.width / 2, play.height/2 - 250 );
    ctx.fillText("Tekan ESC: quit the current game", play.width / 2, play.height/2 - 210);
